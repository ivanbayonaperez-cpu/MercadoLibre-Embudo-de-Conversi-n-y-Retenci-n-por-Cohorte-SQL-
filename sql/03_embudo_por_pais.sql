-- =====================================================
-- Paso 3: Embudo de conversión segmentado por país
-- Objetivo: replicar el embudo general pero agrupado por
-- country, para detectar variaciones regionales de conversión.
-- =====================================================
